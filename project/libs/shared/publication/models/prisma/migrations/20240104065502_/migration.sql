-- AlterTable
ALTER TABLE "video_publics" ADD COLUMN     "tagId" TEXT;
...
-- AddForeignKey
ALTER TABLE "video_publics" ADD CONSTRAINT "video_publics_tagId_fkey" FOREIGN KEY ("tagId") REFERENCES "tags"("id") ON DELETE SET NULL ON UPDATE CASCADE;
